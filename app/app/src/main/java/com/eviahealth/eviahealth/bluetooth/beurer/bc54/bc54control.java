package com.eviahealth.eviahealth.bluetooth.beurer.bc54;
...
public class bc54control {
    private static String TAG = "BC540CONTROL";
    ...
    public void initialize(Context context, String address) {
        ...
        EVLog.log(TAG,"mRC54control.initialize()");
...
//                Log.e(TAG, "Unable to initialize Bluetooth");
    ...
    public void destroy(){
        Log.e(TAG, "onDestroy()");
        EVLog.log(TAG,"mRC54control.onDestroy()");
        if (cTimer != null) {
            cTimer.cancel();
            cTimer = null;
        }
    ...
    public void disconnect(){
        if (mBluetoothLeService != null) {
            EVLog.log(TAG,"mRC54control.disconnect()");
    ...
    public void setIndicateNotificate(int i) {
        ...
        String propierties = bc54GattAttributes.getPropierties(characteristic.getUuid().toString());

        // Solicitamos activación
        mBluetoothLeService.setActivatePropiertiesCharacteristic(characteristic,propierties, bc54GattAttributes.UUID_DESCRIPTOR_CHARACTERISTIC_01);
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action) {
                ...
                case BluetoothLeService.ACTION_CHARACTERISTIC_CHANGED:
                    ...
                    if (buffer.length >= bc54GattAttributes.LENGTH_BLOOD_PRESSURE_MEASUREMENT) {
                ...
                case BluetoothLeService.ACTION_DATA:
                    ...
                    if (uuid.equals(bc54GattAttributes.CHARACTERISTIC_2A35)) {
                        //region :: RESPONSE
                        if (data.length == bc54GattAttributes.LENGTH_BLOOD_PRESSURE_MEASUREMENT) {
