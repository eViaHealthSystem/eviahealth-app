...
public class view_failGBS2012B extends BaseActivity implements View.OnClickListener {

    private String TAG = "VIEW_FAIL_GBS2012B";
    final String FASE = "BÁSCULA GBS2012B";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_fail_gbs2012_b);
...
//        type_puls = extras.getInt("id_dispositivo");
        ...
        btContinuar = findViewById(R.id.gbs2012b_btderecha_fail);
        btReintentar = findViewById(R.id.gbs2012b_btizquierda_fail);

        txtTitulo = findViewById(R.id.gbs2012b_txtTitulo_pul_fail);
        txtMensaje = findViewById(R.id.gbs2012b_txtTexto_pul_fail);
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.gbs2012b_btizquierda_fail) {
        ...
        else if (viewId == R.id.gbs2012b_btderecha_fail) {
