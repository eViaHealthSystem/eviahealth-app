package com.eviahealth.eviahealth.bluetooth.beurer.bc87;
...
public class bc87control {
    private static String TAG = "BC87-CONTROL";
...
//                Log.e(TAG, "Unable to initialize Bluetooth");
    ...
    public void setIndicateNotificate(int i) {
        ...
        String propierties = bc87GattAttributes.getPropierties(characteristic.getUuid().toString());

        // Solicitamos activación
        mBluetoothLeService.setActivatePropiertiesCharacteristic(characteristic,propierties, bc87GattAttributes.UUID_DESCRIPTOR_CHARACTERISTIC_01);
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action) {
                ...
                case BluetoothLeService.ACTION_CHARACTERISTIC_CHANGED:
                    ...
                    if (buffer.length >= bc87GattAttributes.LENGTH_BLOOD_PRESSURE_MEASUREMENT) {
                ...
                case BluetoothLeService.ACTION_DATA:
                    ...
                    if (uuid.equals(bc87GattAttributes.CHARACTERISTIC_2A35)) {
                        //region :: RESPONSE
                        if (data.length == bc87GattAttributes.LENGTH_BLOOD_PRESSURE_MEASUREMENT) {
