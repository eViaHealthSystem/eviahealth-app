...
public class bc54DataTensiometro {
    ...
    // SINGLETON
    private static bc54DataTensiometro instance = null;
    public static bc54DataTensiometro getInstance() {
        if(instance == null) {
            instance = new bc54DataTensiometro("{}");
        }
        return instance;
    }

    // Constructor
    private bc54DataTensiometro(String messure){
        Log.e("BC54DATA","bc54DataTensiometro(String messure)****************************************************************");
    ...
    public void setMessure(String medida) {
        ...
        this.problems = bc54control.msgGetMeasurementStatus(this.messure);
