...
public class bc87GattAttributes {
...
//    public static final UUID UUID_DESCRIPTOR_CHARACTERISTIC_02 = UUID.fromString(DESCRIPTOR_CHARACTERISTIC_02);
    ...
    static {
        ...
        attributes.put("00002a24-0000-1000-8000-00805f9b34fb", "read");         // Model Number String "BC87"
        ...
        attributes.put("00002a36-0000-1000-8000-00805f9b34fb", "none");         // Intermediate Cuff Pressure (not used by BC87) notify
