    ...
    static {
        ...
        MAP.put(-1, new DescripcionErrorGeneric(
                ...
                "Compruebe si su aparato muestra un mensaje de error:" +"\n\n" +
                        "E1:     El pulso no se ha podido registrar.\n" +
                        "             Repita la medición tras una pausa de un minuto." +"\n" +
                        "E2:     Se ha movido o ha hablado durante la medición.\n" +
                        "             Asegúrese de no hablar ni moverse durante la medición." +"\n" +
                        "E3:     El brazalete se ha colocado demasiado tenso o demasiado flojo.\n" +
                        "             Siga las instruciones que se muestran." +"\n" +
                        "E4:     Se ha producido un error durante la medición.\n" +
                        "             Repita la medición tras una pausa de un minuto." + "\n" +
                        "E5:     Presión de infalado es superior a 300 mmHg.\n" +
                        "             Repita la medición tras una pausa de un minuto." +"\n" +
                        "E6:     Las pilas están casi gastadas.\n" +
                        "             Introduzca nuevas pilas en el aparato." +"\n" +
                        "E7:     Los datos no se han podido transmitir por Bluetooth.\n" +
