package com.eviahealth.eviahealth.models.beurer.bc85;
...
public class bc85DataTensiometro {
    ...
    // SINGLETON
    private static bc85DataTensiometro instance = null;
    public static bc85DataTensiometro getInstance() {
        if(instance == null) {
            instance = new bc85DataTensiometro("{}");
        }
        return instance;
    }

    // Constructor
    private bc85DataTensiometro(String messure){
        Log.e("BC85DATA","bc85DataTensiometro(String messure)****************************************************************");
    ...
    public void setMessure(String medida) {
        ...
        this.problems = bc85control.msgGetMeasurementStatus(this.messure);
