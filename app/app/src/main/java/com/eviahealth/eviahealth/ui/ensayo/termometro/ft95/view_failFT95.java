...
import com.eviahealth.eviahealth.models.beurer.ft95.ft95Errors;
...
public class view_failFT95 extends BaseActivity implements View.OnClickListener {

    private String TAG = "VIEW__FAILFT95";
    final String FASE = "TERMOMETRO FT95";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_fail_ft95);
        ...
        _status_descarga = datos.getStatusDescarga();
...
//            btReintentar.setVisibility(View.INVISIBLE);
            ...
            titulo = "Su medida de temperatura se ha descargado correctamente.";
            mensage = "Temperatura:   " + datos.getValor() + " ºC";
            ...
            EnsayoLog.log(FASE,TAG,"Ha fallado la descarga de la medición de temperatura");

            btReintentar.setVisibility(View.VISIBLE);

            titulo = "NO se ha podido obtener la medición de temperatura !!!\r\n";
            txtTitulo.setTextColor(Color.rgb(180,33,33)); //color rojizo

            DescripcionErrorThermo desc = ft95Errors.DescripcionErrorThermo(datos.get_error_num());
            if (desc == null){
                desc = ft95Errors.DescripcionErrorThermo(-1);
            }
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.buttonReintentar) {
            ...
            startActivity(new Intent(this, get_dataFT95.class));
            finish();
            //endregion
        }
            ...
            texto.add(titulo);
            if (mensage.contains("Temperatura:")) {
