package com.eviahealth.eviahealth.models.beurer.bc87;
...
public class bc87DataTensiometro {
    ...
    // SINGLETON
    private static bc87DataTensiometro instance = null;
    public static bc87DataTensiometro getInstance() {
        if(instance == null) {
            instance = new bc87DataTensiometro("{}");
        }
        return instance;
    }

    // Constructor
    private bc87DataTensiometro(String messure){
        Log.e("BC87DATA","bc87DataTensiometro(String messure)****************************************************************");
    ...
    public void setMessure(String medida) {
        ...
        this.problems = bc87control.msgGetMeasurementStatus(this.messure);
