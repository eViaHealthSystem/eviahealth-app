...
public class view_dataClassicScale extends BaseActivity implements View.OnClickListener  {

    private String TAG = "VIEW_SCALE_CLASSIC";
    final String FASE = "CLASSIC SCALE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_data_classic_scale);
...
//        type_puls = extras.getInt("id_dispositivo");
        ...
        btReintentar = findViewById(R.id.scale_btizquierda);

        // valores
        valTxtPeso = findViewById(R.id.scale_weight);
        valTxtIMC = findViewById(R.id.scale_imc);
        ...
        try {
            ...
            if (Config.getInstance().getMultipaciente() == true) {
                ...
                TextView txtLabelIMC = findViewById(R.id.scale_label_imc);
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.scale_btizquierda) {
        ...
        else if (viewId == R.id.imageButtonAudio_scale) {
            //region :: LEER TEXTO
