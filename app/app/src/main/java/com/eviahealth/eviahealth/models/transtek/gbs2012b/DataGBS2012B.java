package com.eviahealth.eviahealth.models.transtek.gbs2012b;
...
public class DataGBS2012B {
    private String TAG = "DataGBS2012B";
    ...
    // SINGLETON
    private static DataGBS2012B instance = null;
    public static DataGBS2012B getInstance() {
        if(instance == null) {
            instance = new DataGBS2012B(false, null);
        }
        return instance;
    }

    // Constructor
    private DataGBS2012B(Boolean statusDescarga, String onlineResul){
    ...
    public void setWeightMeasurement(LSScaleWeight measure, int heigth) {
        try {
            JSONObject params = new JSONObject();
            params.put("weight", measure.getWeight());
            Double imc = measure.getWeight() / ((heigth/100f) * (heigth/100f));
            params.put("imc", roundDouble(imc));
            this.onlineResul = params.toString();
            Log.e(TAG,"setWeightMeasurement >> " + this.onlineResul);
        }
