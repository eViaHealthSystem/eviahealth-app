...
import com.eviahealth.eviahealth.models.ihealth.nt13b.ErroresThermo;
...
public class view_failNT13B extends BaseActivity implements View.OnClickListener {

    private String TAG = "VIEW_FAIL_NT13B";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_fail_nt13_b);
...
//            btReintentar.setVisibility(View.INVISIBLE);
            ...
            DescripcionErrorThermo desc = ErroresThermo.DescripcionErrorThermo(datos.get_error_num());
            if (desc == null){
                desc = ErroresThermo.DescripcionErrorThermo(-1);
            }
