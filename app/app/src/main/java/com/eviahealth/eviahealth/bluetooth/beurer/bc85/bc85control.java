...
public class bc85control {
    private static String TAG = "BC85-CONTROL";
    ...
    public void initialize(Context context, String address) {
        ...
        EVLog.log(TAG,"mRC85control.initialize()");
...
//                Log.e(TAG, "Unable to initialize Bluetooth");
    ...
    public void destroy(){
        Log.e(TAG, "onDestroy()");
        EVLog.log(TAG,"mRC85control.onDestroy()");
        if (cTimer != null) {
            cTimer.cancel();
            cTimer = null;
        }
    ...
    public void disconnect(){
        if (mBluetoothLeService != null) {
            EVLog.log(TAG,"mRC85control.disconnect()");
    ...
    public void setIndicateNotificate(int i) {
        ...
        String propierties = bc85GattAttributes.getPropierties(characteristic.getUuid().toString());

        // Solicitamos activación
        mBluetoothLeService.setActivatePropiertiesCharacteristic(characteristic,propierties, bc85GattAttributes.UUID_DESCRIPTOR_CHARACTERISTIC_01);
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action) {
                ...
                case BluetoothLeService.ACTION_CHARACTERISTIC_CHANGED:
                    ...
                    if (buffer.length >= bc85GattAttributes.LENGTH_BLOOD_PRESSURE_MEASUREMENT) {
                ...
                case BluetoothLeService.ACTION_DATA:
                    ...
                    if (uuid.equals(bc85GattAttributes.CHARACTERISTIC_2A35)) {
                        //region :: RESPONSE
                        if (data.length == bc85GattAttributes.LENGTH_BLOOD_PRESSURE_MEASUREMENT) {
