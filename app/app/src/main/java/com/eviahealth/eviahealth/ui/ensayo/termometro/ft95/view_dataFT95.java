...
public class view_dataFT95 extends BaseActivity implements View.OnClickListener {

    private String TAG = "VIEW_DATA_FT95";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_data_ft95);
        ...
        txtTemperatura = findViewById(R.id.ft95_ter);
        //endregion
