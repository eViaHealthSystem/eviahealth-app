...
public class view_failHS2S extends BaseActivity implements View.OnClickListener {

    private String TAG = "VIEW_FAIL_HS2S";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_fail_hs2_s);
        ...
        btContinuar = findViewById(R.id.HS2S_btderecha_fail);
        btReintentar = findViewById(R.id.HS2S_btizquierda_fail);

        txtTitulo = findViewById(R.id.HS2S_txtTitulo_pul_fail);
        txtMensaje = findViewById(R.id.HS2S_txtTexto_pul_fail);
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.HS2S_btizquierda_fail) {
        ...
        else if (viewId == R.id.HS2S_btderecha_fail) {
