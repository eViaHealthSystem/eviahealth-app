...
public class view_dataBC87 extends BaseActivity implements View.OnClickListener {

    private String TAG = "VIEW_DATA_BC87";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_data_bc87);
        ...
        txtSistolica = findViewById(R.id.bc87_sis);
        txtDiastolica = findViewById(R.id.bc87_dia);
        txtPulso = findViewById(R.id.bc87_pulso);
...
//            EnsayoLog.log(FASE,TAG,"Sistólica: " +datos.get_highPressure() + ", Diastólica: " + datos.get_lowPressure() + ", p.p.m: " + datos.get_pulsaciones());
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btizquierda_ten) {
            ...
            Intent in = new Intent(view_dataBC87.this, get_dataBC87.class);
            startActivity(in);
            finish();
            //endregion
        }
