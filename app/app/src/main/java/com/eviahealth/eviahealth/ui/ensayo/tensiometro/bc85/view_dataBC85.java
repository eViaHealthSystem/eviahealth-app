...
public class view_dataBC85 extends BaseActivity implements View.OnClickListener {

    private String TAG = "VIEW_DATA_BC85";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_data_bc85);
        ...
        txtSistolica = findViewById(R.id.bc85_sis);
        txtDiastolica = findViewById(R.id.bc85_dia);
        txtPulso = findViewById(R.id.bc85_pulso);
...
//            EnsayoLog.log(FASE,TAG,"Sistólica: " +datos.get_highPressure() + ", Diastólica: " + datos.get_lowPressure() + ", p.p.m: " + datos.get_pulsaciones());
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btizquierda_ten) {
            ...
            Intent in = new Intent(view_dataBC85.this, get_dataBC85.class);
            startActivity(in);
            finish();
            //endregion
        }
