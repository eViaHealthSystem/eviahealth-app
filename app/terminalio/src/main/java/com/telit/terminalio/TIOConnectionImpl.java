...
class TIOConnectionImpl  implements TIOConnection {
    ...
    */
    ...
    void onDataReceived(final byte []  rxData) {
        ...
        if ( mTio.isTraceEnabled() ) {
            STTrace.line(">> onCharacteristicChanged, RX data "+rxData.length+" rx credits "+mLocalCredits);
        }
...
//            Log.e("TIO","onCharacteristicChanged: " + byteArrayInHexFormat(characteristic.getValue()));
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            Log.e("TIO","onCharacteristicWrite: " + byteArrayInHexFormat(characteristic.getValue()));

//            for (int i = 0; i < characteristic.getValue().length; i++) {
//                Log.e("TIO","onCharacteristicWrite: " + ((int)(characteristic.getValue()[i]) & 0xff));
//            }
